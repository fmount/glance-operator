...
func (in *GlanceSpec) DeepCopyInto(out *GlanceSpec) {
	*out = *in
	...
	out.ImageCacheClean = in.ImageCacheClean
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImageCacheClean) DeepCopyInto(out *ImageCacheClean) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImageCacheClean.
func (in *ImageCacheClean) DeepCopy() *ImageCacheClean {
	if in == nil {
		return nil
	}
	out := new(ImageCacheClean)
	in.DeepCopyInto(out)
	return out
}
